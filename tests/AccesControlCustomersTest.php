...
class AccesControlCustomersTest extends WebTestCase
{
    ...
    public function getUrlCustomersFromAdmin(): Generator
    {
        ...
        yield "Private Customer show" => ['/private/customers/5', Response::HTTP_OK];
        yield "Private Customer edit" => ['/private/customers/5/edit', Response::HTTP_OK];
    ...
    public function getUrlCustomersFromAdministrative(): Generator
    {
        ...
        yield "Private Customer new" => ['/private/customers/new', Response::HTTP_OK];
        yield "Private Customer show" => ['/private/customers/5', Response::HTTP_OK];
        yield "Private Customer edit" => ['/private/customers/5/edit', Response::HTTP_FORBIDDEN];
        //yield "Private Customer delete" => ['/private/customers/1', Response::HTTP_OK];
    ...
    public function getUrlCustomers(): Generator
    {
        ...
        yield "Employee new" => ['/employees/new', Response::HTTP_FORBIDDEN];
        yield "Employee show" => ['/employees/2/details', Response::HTTP_FORBIDDEN];
        yield "Employee edit" => ['/employees/2/edit', Response::HTTP_FORBIDDEN];
        //yield "Employee delete" => ['/employees/2/delete', Response::HTTP_FORBIDDEN];
        ...
        yield "Private Customer show" => ['/private/customers/5', Response::HTTP_FORBIDDEN];
        yield "Private Customer edit" => ['/private/customers/5/edit', Response::HTTP_FORBIDDEN];
        //yield "Private Customer delete" => ['/private/customers/1', Response::HTTP_FORBIDDEN];

        // Customer Professional
        yield "Professional Customer new" => ['/professional/customers/new', Response::HTTP_FORBIDDEN];
        yield "Professional Customer show" => ['/professional/customers/4', Response::HTTP_FORBIDDEN];
        yield "Professional Customer edit" => ['/professional/customers/4/edit', Response::HTTP_FORBIDDEN];
        //yield "Professional Customer delete" => ['/professional/customers/1', Response::HTTP_FORBIDDEN];
    }
